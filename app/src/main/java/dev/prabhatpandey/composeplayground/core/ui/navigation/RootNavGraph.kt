...
import dev.prabhatpandey.composeplayground.features.calendar.ui.ScrollingCalendarScreen
import dev.prabhatpandey.composeplayground.features.calendar.ui.SwipingCalendarScreen
...
fun RootNavGraph(
    ...
    NavHost(
        ...
        swipeCalendarScreen(navController)
        scrollingCalendarScreen(navController)
    }
}
...
fun NavGraphBuilder.swipeCalendarScreen(navController: NavHostController) {
    composable(AppScreen.CalendarSwipe.route) {
        SwipingCalendarScreen()
    }
}
fun NavGraphBuilder.scrollingCalendarScreen(navController: NavHostController) {
    composable(AppScreen.CalendarScrolling.route) {
